...
DHT dht(DHT_data,DHT11);
 ...
 //για AES CRC
const unsigned char key[] = "ffffffffffffffff";
...
unsigned char prev_iv[] ={0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46};
...
void loop() {
 ...
 if(digitalRead(smoke_sensor)==0){
  ...
  //αν ποιασει το φωτολυταρο θα πηγαινει εναλαξ τουσ μετρητες
